...
##############################################################################
#### code for "Label Decoupling Framework for Salient Object Detection"#######
#### by Jun Wei, Shuhui Wang, Zhe Wu, Chi Su, Qingming Huang, Qi Tian  #######
#### https://github.com/weijun88/LDF/tree/master                       #######
##############################################################################
...
class ResNet(nn.Module):
    ...
    def initialize(self):
        self.load_state_dict(torch.load('/home/wilson/.cache/torch/checkpoints/resnet50-19c8e357.pth'), strict=False)
...
if __name__ == '__main__':
    ...
    input = torch.rand((2, 3, 512, 512), device='cuda', dtype=torch.float)
