...
_base_ = [
    '../_base_/models/perpixel_decouple_plus_beit.py',
    # '../_base_/datasets/ade20k.py',
    '../_base_/datasets/VishaDatasetVideoLabelDecoupleTestMulti.py',
...
model = dict(
    type='EncoderDecoderPerPixelPlusAugVideoTestMulti',
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(4*img_size, img_size), ratio_range=(0.5, 2.0)),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Normalize', **img_norm_cfg),
            dict(type='PadShortSide', size=img_size, pad_val=0, seg_pad_val=0),
